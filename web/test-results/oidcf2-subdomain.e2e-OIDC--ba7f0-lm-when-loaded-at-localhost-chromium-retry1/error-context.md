...
- Name: oidcf2-subdomain.e2e.spec.ts >> OIDC-F-06 — Dynamic OIDC config: default realm from localhost >> TC-OIDCF2-03: SSO button navigation targets bpm-default realm when loaded at localhost
- Location: tests\e2e\oidcf2-subdomain.e2e.spec.ts:97:3
