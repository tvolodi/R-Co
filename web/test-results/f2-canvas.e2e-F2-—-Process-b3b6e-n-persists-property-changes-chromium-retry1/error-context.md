...
- complementary:
  ...
  - button "Sign out"
- main:
  - heading "Save Test pd-ui-canvas-e2e-save-03-1780044221339" [level=2]
  ...
  - application:
    - img:
      - group "Edge from start to task-pd-ui-canvas-e2e-save-03-1780044221339"
    - img:
      - group "Edge from task-pd-ui-canvas-e2e-save-03-1780044221339 to end"
    - group:
      - img
    - group:
      - img
      - text: Saved Task pd-ui-canvas-e2e-save-03-1780044221339 Human Task
    - group:
      - img
    - img
    - img "Mini Map"
  ...
  - text: Properties
  - button "Close panel": ✕
  - text: "Node: task-pd-ui-canvas-e2e-save-03-1780044221339 (HUMAN_TASK) Name"
  - textbox "Node name": Saved Task pd-ui-canvas-e2e-save-03-1780044221339
  - text: Assignee Type
  - combobox:
