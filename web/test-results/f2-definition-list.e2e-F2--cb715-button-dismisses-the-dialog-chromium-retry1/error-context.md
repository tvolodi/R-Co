...
- Name: f2-definition-list.e2e.spec.ts >> F2 — Definition List View (PD-UI-01 through PD-UI-04) >> PD-UI-04 — Create definition >> TC-PDUI04-05: Cancel button dismisses the dialog
- Location: tests\e2e\f2-definition-list.e2e.spec.ts:478:5
