...
- Name: sh01-04.shell.e2e.spec.ts >> SH-04 — Active user indicator >> TC-SH04-03: logout button clears session and navigates to /login
- Location: tests\e2e\sh01-04.shell.e2e.spec.ts:267:3
