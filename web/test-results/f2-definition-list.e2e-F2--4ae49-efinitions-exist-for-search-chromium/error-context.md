...
- Name: f2-definition-list.e2e.spec.ts >> F2 — Definition List View (PD-UI-01 through PD-UI-04) >> PD-UI-01 — Definition list >> TC-PDUI01-02: empty state renders when no definitions exist for search
- Location: tests\e2e\f2-definition-list.e2e.spec.ts:204:5
...
Locator: getByText('No definitions found')
Expected: visible
Timeout: 10000ms
...
Call log:
  ...
  - waiting for getByText('No definitions found')
...
- main:
  ...
  - textbox "Search definitions...": nonexistent-1779987530951
  - text: Status
  - combobox:
    - option "All" [selected]
    - option "Draft"
