...
- Name: sh01-04.shell.e2e.spec.ts >> SH-04 — Active user indicator >> TC-SH04-01: sidebar header shows display_name from JWT
- Location: tests\e2e\sh01-04.shell.e2e.spec.ts:245:3
