...
- Name: sh05-06.shell.e2e.spec.ts >> SH-06 — API Connectivity Banner >> TC-SH06-02: /health/ready returns 503 → connectivity-banner visible
- Location: tests\e2e\sh05-06.shell.e2e.spec.ts:102:3
