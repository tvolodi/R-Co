...
- Name: sh01-04.shell.e2e.spec.ts >> SH-01 — Token-based login >> TC-SH01-01: login page renders token input and submit button
- Location: tests\e2e\sh01-04.shell.e2e.spec.ts:93:3
