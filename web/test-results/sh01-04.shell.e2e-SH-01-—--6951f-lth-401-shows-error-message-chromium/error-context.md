...
- Name: sh01-04.shell.e2e.spec.ts >> SH-01 — Token-based login >> TC-SH01-03: invalid token (health 401) shows error message
- Location: tests\e2e\sh01-04.shell.e2e.spec.ts:117:3
