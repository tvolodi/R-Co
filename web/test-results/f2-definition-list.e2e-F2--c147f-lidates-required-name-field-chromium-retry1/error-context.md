...
- Name: f2-definition-list.e2e.spec.ts >> F2 — Definition List View (PD-UI-01 through PD-UI-04) >> PD-UI-04 — Create definition >> TC-PDUI04-02: dialog validates required name field
- Location: tests\e2e\f2-definition-list.e2e.spec.ts:427:5
...
Call log:
  - waiting for getByTestId('create-submit')
    - locator resolved to <button disabled data-testid="create-submit">Create</button>
    ...
    - generic [ref=e23]:
      ...
      - generic [ref=e201]:
        ...
        - generic [ref=e203]:
          ...
          - textbox "My Process" [active] [ref=e205]
        - generic [ref=e206]:
          - generic [ref=e207]: Version *
          - textbox "1.0.0" [ref=e208]
        - generic [ref=e209]:
          - generic [ref=e210]: Description
          - textbox "Optional description" [ref=e211]
        - generic [ref=e212]:
          - button "Cancel" [ref=e213] [cursor=pointer]
          - button "Create" [disabled] [ref=e214]
```
