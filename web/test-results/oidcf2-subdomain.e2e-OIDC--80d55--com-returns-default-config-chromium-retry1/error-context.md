...
- Name: oidcf2-subdomain.e2e.spec.ts >> OIDC-F-05 — Tenant-config endpoint: unknown hostname >> TC-OIDCF2-01: GET /api/tenant-config?host=unknown.example.com returns default config
- Location: tests\e2e\oidcf2-subdomain.e2e.spec.ts:43:3
