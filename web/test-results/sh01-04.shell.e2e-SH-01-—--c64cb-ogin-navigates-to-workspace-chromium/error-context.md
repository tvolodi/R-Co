...
- Name: sh01-04.shell.e2e.spec.ts >> SH-01 — Token-based login >> TC-SH01-02: valid token login navigates to workspace
- Location: tests\e2e\sh01-04.shell.e2e.spec.ts:105:3
