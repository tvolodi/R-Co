...
- Name: sh01-04.shell.e2e.spec.ts >> SH-02 — Session persistence and expiry >> TC-SH02-01: auth:session-expired event navigates to /login?reason=session-expired
- Location: tests\e2e\sh01-04.shell.e2e.spec.ts:148:3
