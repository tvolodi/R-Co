...
- complementary:
  ...
  - button "Sign out"
- main:
  - heading "Full Save pd-ui-canvas-e2e-fullsave-01-1780044237374" [level=2]
  ...
  - application:
    - img:
      - group "Edge from start to task-pd-ui-canvas-e2e-fullsave-01-1780044237374"
    - img:
      - group "Edge from task-pd-ui-canvas-e2e-fullsave-01-1780044237374 to end"
    - group:
      - img
    - group:
      - img
      - text: Full Saved Task pd-ui-canvas-e2e-fullsave-01-1780044237374 Human Task
    - group:
      - img
    - img
    - img "Mini Map"
  ...
  - text: Properties
  - button "Close panel": ✕
  - text: "Node: task-pd-ui-canvas-e2e-fullsave-01-1780044237374 (HUMAN_TASK) Name"
  - textbox "Node name": Full Saved Task pd-ui-canvas-e2e-fullsave-01-1780044237374
  - text: Assignee Type
  - combobox:
