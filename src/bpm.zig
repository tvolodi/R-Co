...
pub const agent_artifacts_routes = @import("api/routes/agent_artifacts.zig"); // AGT-01..07
pub const artifact_retention_mod = @import("scheduler/artifact_retention.zig"); // AGT-06
